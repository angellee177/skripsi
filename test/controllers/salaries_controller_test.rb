...
class SalariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salary" do
    assert_difference('Salary.count') do
      post salaries_url, params: { salary: { bonus: @salary.bonus, montir_id: @salary.montir_id, potongan: @salary.potongan, sale_id: @salary.sale_id, subtotal: @salary.subtotal, total: @salary.total } }
    end
  ...
  test "should update salary" do
    patch salary_url(@salary), params: { salary: { bonus: @salary.bonus, montir_id: @salary.montir_id, potongan: @salary.potongan, sale_id: @salary.sale_id, subtotal: @salary.subtotal, total: @salary.total } }
